        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PercentOfSystem = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    PercentOfSeller = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Paint = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Groupset = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Operating = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TireRim = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bikes_Inspections_InspectionId",
                        column: x => x.InspectionId,
                        principalTable: "Inspections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Bikes_Listings_ListingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Bikes_BikeId",
                        column: x => x.BikeId,
                        principalTable: "Bikes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wishlists_Bikes_BikeId",
                        column: x => x.BikeId,
                        principalTable: "Bikes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_CartId_BikeId",
                table: "CartItems",
                columns: new[] { "CartId", "BikeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medias_BikeId",
                table: "Medias",
                column: "BikeId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_BikeId",
                table: "OrderItems",
                column: "BikeId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrderId_BikeId",
                table: "OrderItems",
                columns: new[] { "OrderId", "BikeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_UserId_Revoked_ExpiredAt",
                table: "RefreshTokens",
                columns: new[] { "UserId", "Revoked", "ExpiredAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_BikeId",
                table: "Wishlists",
                column: "BikeId");

            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_UserId_BikeId",
                table: "Wishlists",
